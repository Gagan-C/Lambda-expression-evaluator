/* Generated By:JJTree&JavaCC: Do not edit this line. Prog03.java */
import java.util.Scanner;

class Prog03/*@bgen(jjtree)*/implements Prog03TreeConstants, Prog03Constants {/*@bgen(jjtree)*/
  protected static JJTProg03State jjtree = new JJTProg03State();public static void main(String args[]) {
...
//  User input
    ...
    try {
     ...
     // SimpleNode newTree = rootNode.substitute(subVar,(SimpleNode)subExpr.jjtGetChild(0));
      ...
      SimpleNode rootNode2 = (SimpleNode) n2.jjtGetChild(0);
      rootNode2.dump("");
      System.out.println();
      System.out.println("Enter the variable to be substituted:");
      Scanner sc = new Scanner(System.in);
      String varSub = sc.nextLine();
      System.out.println();
      System.out.println("Enter the substituting applied lambda expression:");
      t.ReInit(System.in);
      ASTStart n3 = t.Start();
      System.out.println();
      System.out.println("The abstract syntax tree:");
      SimpleNode rootNode3 = (SimpleNode) n3.jjtGetChild(0);
      rootNode3.dump("");
      System.out.println();
      System.out.println("The Substitution result:");
      SimpleNode subResult = rootNode2.cloneTree(); //For substitution creating a clone
      subResult = subResult.substitute(varSub, rootNode3);
      subResult.dump("");
      System.out.println();
      //Reduction
      System.out.println("Enter an applied Lambda expression(For reduction)");
      t.ReInit(System.in);
      ASTStart n4 = t.Start();
      System.out.println();
      SimpleNode rootNode4 = (SimpleNode) n4.jjtGetChild(0);
      SimpleNode result = rootNode4.cloneTree();
 ...
 /*@bgen(jjtree) Integer */
  ...
  static public Prog03TokenManager token_source;
  ...
  public Prog03(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Prog03(java.io.InputStream stream, String encoding) {
    ...
    token_source = new Prog03TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Prog03(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public Prog03(Prog03TokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(Prog03TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
